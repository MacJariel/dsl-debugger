...
public class KarelStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.macjariel.karel.KarelRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.macjariel.org/karel/Karel")) {
		EPackage.Registry.INSTANCE.put("http://www.macjariel.org/karel/Karel", org.macjariel.karel.karel.KarelPackage.eINSTANCE);
	}
