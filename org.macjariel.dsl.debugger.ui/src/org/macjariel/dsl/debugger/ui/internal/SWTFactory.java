...
/**
 * Factory class to create some SWT resources, based on
 * org.eclipse.debug.internal.ui.SWTFactory class.
 * 
 * @author MacJariel
 */
public class SWTFactory {
	 ...
	 * @since 3.3
	 */
	public static Button createCheckButton(Composite parent, String label, Image image,
	 ...
	 * @since 3.6
	 */
	public static Button createPushButton(Composite parent, String label, String tooltip,
			Image image) {
	 ...
	 * @since 3.3
	 */
	public static CLabel createWrapCLabel(Composite parent, String text, Image image, int hspan,
			int wrapwidth) {
	 ...
	 * @since 3.3
	 */
	public static Text createText(Composite parent, int style, int hspan, int width, int height,
			int fill) {
		Text t = new Text(parent, style);
		t.setFont(parent.getFont());
		GridData gd = new GridData(fill);
	 ...
	 */
	public static Composite createComposite(Composite parent, Font font, int columns, int hspan,
			int fill, int marginwidth, int marginheight) {
		Composite g = new Composite(parent, SWT.NONE);
	 ...
	 * @since 3.6
	 */
	public static ViewForm createViewform(Composite parent, int style, int cols, int span,
			int fill, int marginwidth, int marginheight) {
	 ...
	 * @since 3.6
	 */
	public static Composite createComposite(Composite parent, Font font, int style, int columns,
			int hspan, int fill, int marginwidth, int marginheight) {
